export function PrimaryButton({ children, className }) {
  return (
    <button className={`px-10 py-3 bg-[#26231E] text-white rounded-full hover:bg-gray-600 transition-colors cursor-pointer text-[16px] leading-[24px] font-base ${className}`}>
      {children}
    </button>
  );
}
